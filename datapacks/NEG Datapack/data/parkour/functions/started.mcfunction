...
execute as @a at @s run function negmusic_parkour:play
...
item replace entity @a hotbar.0 with carrot_on_a_stick{display:{Name:'{"text":"Stick of Resetting","color":"gold","bold":true,"italic":false}'},Enchantments:[{id:"minecraft:unbreaking",lvl:10s}]}